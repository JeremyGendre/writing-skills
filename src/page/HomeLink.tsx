...
export default function HomeLink(props: Props) {
    return (
        <Link to={ props.path } className="homepage-link transition duration-150 overflow-hidden relative flex border-4 border-white shadow-md-dark hover:shadow-dark w-full bg-cover md:w-96 mx-auto my-4 bg-black text-white h-72">
